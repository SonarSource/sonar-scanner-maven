...
/**
 * Patched version of DependencyTreeResolutionListener to fix MSONAR-135
 */
public class DependencyTreeResolutionListener
   ...
   *             {@link org.apache.maven.shared.dependency.tree.traversal.CollectingDependencyNodeVisitor} on the root
   *             dependency node
   */
