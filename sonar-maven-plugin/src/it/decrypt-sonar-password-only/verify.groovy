...
assert properties.'sonar.scanner.relevantSecretFromEnv' == '{ABCDEFGHIJKLMNOPQRSTUVWXYZ=}cannot-decrypt'
assert properties.'sonar.relevant.secret.from.pom' == '{ABCDEFGHIJKLMNOPQRSTUVWXYZ=}cannot-decrypt'
assert properties.'sonar.relevant.secret.from.cli' == '{ABCDEFGHIJKLMNOPQRSTUVWXYZ=}cannot-decrypt'
...
assert properties."$sonarModuleSonarProp" == '{ABCDEFGHIJKLMNOPQRSTUVWXYZ=}cannot-decrypt'
assert !properties.stringPropertyNames().contains("$sonarModuleUnknownProp")
assert properties."$anotherModuleSonarProp" == '{ABCDEFGHIJKLMNOPQRSTUVWXYZ=}cannot-decrypt'
