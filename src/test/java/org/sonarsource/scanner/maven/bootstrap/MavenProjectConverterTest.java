...
public class MavenProjectConverterTest {
  ...
  public void overrideSourcesMultiModuleProject() throws Exception {
    ...
    assertThat(props.getProperty(module2Key + ".sonar.binaries")).isEqualTo(module2BinaryDir.getAbsolutePath());
    assertThat(props.getProperty(module2Key + ".sonar.groovy.binaries")).isEqualTo(module2BinaryDir.getAbsolutePath());
    assertThat(props.getProperty(module2Key + ".sonar.java.binaries")).isEqualTo(module2BinaryDir.getAbsolutePath());
  }
  ...
  public void includeSourcesInNonLeafWhenExplicitlyRequested() throws Exception {
    ...
    String rootSources = baseDir + "/pom.xml," + baseDir + "/src/main/java";
    assertThat(props.getProperty("sonar.sources")).isEqualTo(rootSources);
    String leafSources = module1PomPath + "," + module1SrcPath;
    assertThat(props.getProperty("com.foo:module1.sonar.sources")).isEqualTo(leafSources);
  }
